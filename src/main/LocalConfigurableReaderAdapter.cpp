...
void
LocalConfigurableReaderAdapter::activateProtocol(
...
void
LocalConfigurableReaderAdapter::deactivateProtocol(
...
const std::string&
LocalConfigurableReaderAdapter::getCurrentProtocol() const
{
