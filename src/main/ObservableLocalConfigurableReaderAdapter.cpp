...
: ObservableLocalReaderAdapter(
    std::dynamic_pointer_cast<ObservableReaderSpi>(configurableReaderSpi),
    pluginName)
{
}

void
ObservableLocalConfigurableReaderAdapter::activateProtocol(
...
void
ObservableLocalConfigurableReaderAdapter::deactivateProtocol(
...
const std::string&
ObservableLocalConfigurableReaderAdapter::getCurrentProtocol() const
{
