...
const std::string&
CardSelectionResponseAdapter::getPowerOnData() const
{
    /* RL-ATR-IDENTIFY.1 */
    return mPowerOnData;
}
...
bool
CardSelectionResponseAdapter::hasMatched() const
{
    return mHasMatched;
}

const std::shared_ptr<CardResponseApi>
CardSelectionResponseAdapter::getCardResponse() const
{
...
std::ostream&
operator<<(
    std::ostream& os, const std::shared_ptr<CardSelectionResponseAdapter> csra)
{
    os << *csra.get();
