...
enum class MonitoringState {
    /**
     * The reader is idle and waiting for a start signal to enter the card
     * detection mode.
     *
     * @since 2.0.0
     */
    ...
    /**
     * The reader is in card detection mode and is waiting for a card to be
     * presented.
     *
     * @since 2.0.0
     */
